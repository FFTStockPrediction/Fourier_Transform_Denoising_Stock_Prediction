...
In this folder, we have collected the performance data for the LSTM model using each of the five denoising techniques. 
...
The Python file “Stock_LSTM_MultiStocks.ipynb” contains the LSTM model, denoising techniques, and method to collect performance data. 
...
For example, the CSV titled “Short_LSTM_Exp_LDD_Results.csv” contains the tabular performance data for short-term prediction using Exp-LDD denoising. 
