...
In this folder, we have collected the performance data for the Transformer model using each of the five denoising techniques. 
...
The Python file “Stock_Transformers_MultiStocks.ipynb” contains the Transformer model, denoising techniques, and method to collect performance data. 
...
For example, the CSV titled “Short_Transformer_Exp_LDD_Results.csv” contains the tabular performance data for short-term prediction using Exp-LDD denoising. 
